...
const Banner = () => {
  ...
  return (
    <section
      className='bg-red-300 h-[80vh] mt-[14vh] bg-cover bg-top'
      style={{ backgroundImage: `url(${BannerImage})` }}
    >
      <div className='max-w-325 mx-auto px-12 h-100 flex flex-col justify-center gap-3'>
...
//     const storedTime = localStorage.getItem('remainingTime');
//     return storedTime && parseInt(storedTime, 10) > 0 ? 
//     PiSquareSplitHorizontalThin(storedTime, 10) : initialTime
//   });
...
//     return{
//       hours: String(hours).padString(2, '0'),
//       minutes: String(minutes).padString(2, '0'),
//       seconds: String(seconds).padString(2, '0')
//     }
//   }
...
//     <section className='bg-red-300 h-[80vh] mt-[14vh] bg-cover bg-top' style={{backgroundImage: `url(${BannerImage})`}}>
//       <div className='max-w-325 mx-auto px-12 h-100 flex flex-col justify-center gap-3 '>
