...
const Wishlist = ({activePanel}) => {
  return (
    <div className={`flex flex-col justify-between gap-5 bg-zinc-100 fixed top-0 right-0 bottom-0 z-40 left-auto w-100 border-2 border-zinc-300 py-7 transform transition-transform duration-300 
      ...
      <div className="flex-1">
        <div className="flex item-center gap-3 bg-white px-5 py-1 border-y-2 border-zinc-300">
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between">
              <span>$0.00</span>
              <button className="bg-blue-600 text-sm px-5 py-1 rounded-full active:bg-blue-700 cursor-pointer">Add to Cart</button>
            </div>
          </div>
        </div>
      </div>
